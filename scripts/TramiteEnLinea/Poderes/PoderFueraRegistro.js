...
$(document).ready(function () {
    ...
    //  document.addEventListener("backbutton", botonbackdemo, false);
    $("#DivFormPoderSinMinuta").hide();

    ////////////////////////apoderado

    find_doc_identidad_poder();
    find_status_civil_poder();
    find_country_poder();
...
function Notif() {
    ...
    var color = "blue";
    var mensaje = "SOLICITUD ENVIADA PODERES FUERA DE REGISTRO"
    var estado = 1;
    var mostrado = 0;
...
var ResultInsertPoderFueraRegistro;
var ResultInsertPodernante;
var ResultInsertApoderado;

function InsertPoderFueraRegistro(callback) {
    var arreglo = [];
    ...
    $.post("https://www.dotnetsa.com/PAINOSERVICE/app/controller/ControllerPoderes.php", "op=Insert_Poderes&PodFch=" + "2020-04-25" + "&PodTip=" + "PS" + "&PodNumero=" + 0 + "&PodNumFch=" +
        ...
        function (result) {
            ...
            ResultInsertPoderFueraRegistro=result;
            console.log(ResultInsertPoderFueraRegistro);
            ...
            if (result == 1) {
                ...
                grabarLog(result, 'InsertPoderFueraRegistro', 'PODER FUERA REGISTRO')
            }
    ...
    $.post("https://dotnetsa.com/PAINOSERVICE/app/controller/ControllerPoderes.php", "op=PartPoderes&PodPerTide=" + PodPerTide +
        ...
        function (result) {
            ...
            if (result == 1) {
                ...
                grabarLog(result, 'InsertPodernante', 'PODER FUERA REGISTRO')
            }
        });
};
...
function InsertApoderado() {
    ...
    var PodPerNac = $("#cboIPPais_APO").val();
    ...
    $.post("https://dotnetsa.com/PAINOSERVICE/app/controller/ControllerPoderes.php", "op=PartPoderes&PodPerTide=" + PodPerTide +
        ...
        function (result) {
            ...
            if (result == 1) {
                ...
                grabarLog(result, 'InsertApoderado', 'PODER FUERA REGISTRO')
            }
        });
};
    ...
    $.post("https://www.dotnetsa.com/PAINOSERVICE/app/controller/ControllerCliente.php",
        ...
        function (result) {
            ...
            if (result == 1) {
                ...
                grabarLog(result, 'InsertPodernanteTMPER10', 'PODER FUERA REGISTRO')
            }
        });
...
function InsertApoderadoTMPER10() {
    ...
    var PerNacion = $("#cboNacionalidad_APO").val();
    ...
    $.post("https://www.dotnetsa.com/PAINOSERVICE/app/controller/ControllerCliente.php",
        ...
        function (result) {
            ...
            if (result == 1) {
                ...
                grabarLog(result, 'InsertApoderadoTMPER10', 'PODER FUERA REGISTRO')
            }
        });
...
$("#chbapoderado_add").change(function () {
    ...
    if ($("#chbapoderado_add").prop("checked") == true) {
        ...
        $("#APO_ADD").show();
        apoderadoadd = true;
        console.log("Chekado add apoderado : ", apoderadoadd);
    }
    if ($("#chbapoderado_add").prop("checked") == false) {
        console.log("false");
        $("#APO_ADD").hide();
        apoderadoadd = false;
        console.log("Chekeador add apoderado : ", apoderadoadd);
    }
});
...
function InsertClientVIP_POADD() {
...
function find_doc_identidad_poder() {
    ...
    $.post("https://www.dotnetsa.com/PAINOSERVICE/app/controller/Combos.php", "op=get_DocsIdentidad", function (result) {
        ...
        $.each(arreglo, function (idx, item) {
            var opciones = "<option value='" + item.TIdeCod + "'>" + item.TIdeDes + "</option>";
            $("#CBO_T_POSR").append(opciones);
            $("#CBO_T_DOC_PO_SM_ADD").append(opciones);
            $("#CBO_T_DOC_PO_SM_T").append(opciones);
            // $("#CBO_T_AOSR").append(opciones);
        });
    });
}

function find_status_civil_poder() {
...
function find_country_poder() {

    $.post("https://www.dotnetsa.com/PAINOSERVICE/app/controller/Combos.php", "op=get_Nacionalidad", function (result) {

        var arreglo = JSON.parse(result);

        //$("#cboNacionalidad_PO").html("");
        //$("#cboNacionalidad_PO").append("<option value='00'>Seleccione</option>");
        $.each(arreglo, function (idx, item) {
            var opciones = "<option value='" + item.PaiCod + "'>" + item.PaiNac + "</option>";
            //$("#cboNacionalidad_PO").append(opciones);
        });
...
$("#btn_Guardar_PSM").click(function () {
    ...
    {
    MostrarPreload();
    InsertPoderFueraRegistro(function (){
        InsertPodernante();
        InsertApoderado();
        setTimeout(() => {
            if(ResultInsertPoderFueraRegistro==1){
                MENSJ(1);
            }else{
                MENSJ(2);
                GuardarErrorLOG();
...
function InsertClientVIP_APO() {
    ...
    $.post("https://www.dotnetsa.com/PAINOSERVICE/app/controller/ControllerCliente.php", "op=insrt_ClienteALL&PerTide=" + PerTide + "&PerIdeNro=" + PerIdeNro + "&PerTPer=" + PerTPer + "&PerApePat=" + PerApePat + "&PerApeMat=" + PerApeMat + "&PerNom=" + PerNom + "&PerNomCo=" + PerNomCo + "&PerECiv=" + PerECiv + "&PerNacion=" + PerNacion + "&PerTlfNro=" + PerTlfNro + "&PerEmail=" + PerEmail + "&PerObser=" + PerObser + "&PerConyTIde=" + PerConyTIde + "&PerConyIde=" + PerConyIde + "&OcuCod=" + OcuCod + "&PerDirDes=" + PerDirDes + "&PerTIdeP=" + PerTIdeP + "&PerIdeNroP=" + PerIdeNroP + "&PerTIdeM=" + PerTIdeM + "&PerIdeNroM=" + PerIdeNroM + "&PerFchNac=" + PerFchNac + "&PerRazSoc=" + PerRazSoc + "&PerRazSocEmail=" + PerRazSocEmail, function (result) {
        ...
        if (result == 1) {
            ...
            Swal.fire({
                icon: 'error',
                title: 'Algunos datos, no se registraron',
                text: 'Poder fuera de registro',
            })
        }
    });
...
function fnAddDomiciloClienteAPO() {
    ...
    var cboIPDIstrito = $('#cboIPDcboIPDIstritoApoIstrito option:selected').html();
...
function DetPoder() {
    ...
    /*if(podernanteadd==true)
    {
        var tdocpoadd= $("#CBO_T_DOC_PO_SM_APOADD").val();
        var ndocpoadd=$("#TXT_N_PSM_POADD").val();
        console.log("Podernante add estado = ",podernanteadd);

    }else if(podernanteadd==false)
    {
        var tdocpoadd= "";
        var ndocpoadd="";
        console.log("Podernante add estado = ",podernanteadd);
...
function grabarDomicilio() {
    ...
    let locationData = {
        PerTIde: $("#CBO_T_POSR").val(),
        PerIdeNro: $("#TXT_N_POSR").val(),
        PerPais: $("#cboIPPais_PO").val(),
        PerDept: $("#cboIPDepartamento").val(),
        PerProv: $("#cboIPProvincia").val(),
        PerDist: $("#cboIPDIstrito").val(),
...
//GRABAR ARRAY DOMICIOLIOS A BASE DE DATOS
function AgregarDomicilioDBA() {
    $.each(arreglo, function (idx, item) {
